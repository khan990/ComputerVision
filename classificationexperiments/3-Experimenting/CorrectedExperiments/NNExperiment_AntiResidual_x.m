...
function [NN_on_Train_features_Train_Labels, NN_on_ErrorResidual_on_Training] = NNExperiment_AntiResidual_x(Train_features, Test_features, Train_Labels, Test_Labels)
        ...
        for k=1:length(AllTrainFunctions)
            ...
            %     NN_on_ErrorResidual_on_Training = train(NN_on_ErrorResidual_on_Training_temp, Train_features, ErrorResidual_on_Training, 'useParallel','yes','useGPU','yes','showResources','yes');
                ...
                %     NN_on_ErrorResidual_on_Training = train(NN_on_ErrorResidual_on_Training_temp, Train_features, ErrorResidual_on_Training, 'useParallel','yes','useGPU','yes','showResources','yes');
                    ...
                    ft_estimated = ft_NN_on_Train_features_Train_Labels{j}(ft_Test_features_GPU);
